...
return [
    ...
    | usados por el validador. Algunas reglas tienen múltiples versiones,
    | como las reglas de tamaño. Puedes ajustar cada mensaje aquí.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres legibles para los campos del formulario.
    |
    */
